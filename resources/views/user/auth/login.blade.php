...
@section('content')
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                ...
                                <p class="text-sm text-center text-gray-500">
                                    New User?
                                    <a href="{{ route('registration') }}" class="text-gray-900 font-medium hover:underline">
                                        Register
                                    </a>
                                </p>
                            </div>
            ...
            <div class="relative items-center hidden w-full h-full bg-white lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    <include src="./partials/common-grid-shape.html"></include>
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="" class="block mb-4">
                            <img src="{{ asset('logo/landmark.png') }}" alt="Logo" class="h-16" />
                        </a>
